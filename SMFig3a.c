...
int main()
{
    ...
    for (int counter_r=0; counter_r<rmax; counter_r++)
    {
        ...
        for (int counter_DG0=0; counter_DG0 < DG0max; counter_DG0++)
        {
            ...
            for (int counter_N=0; counter_N<Nmax; counter_N=counter_N+2)
            {
...
//                    exit(0);
                    ...
                    else 
                    {
                        ...
                        F[hmax]=exp(-beta*Free_energy_diff)*pow((e*rho_ideal*v0),hmax);
                    }
...
//                    outfile << hmax << " " << exp(-betaFreeEnergy+hmax*betaFreeEnergy_bulk) << endl;
                ...
                outfile << rho_ideal*e << " " << gamma << " " << NA << " " << DG0_star_surface << endl;
