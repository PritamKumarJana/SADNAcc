...
/**********************************************************************************************************************************************/
        ...
        //double rhog=0.0000185; // ; 4.36006E-06
        double rhog=0.0;
        //cout << log(rhog)*pow((L/2.0),3)+1 << " " << log(0.01)*pow((L/2.0),3)+1 <<endl;
        //exit(0);
        //double rhog=0.01;
        double delta=1.0; //L/2.0;
...
/*************************************************  overlap calculation *******************************************************/
        ...
        for (int counter_DG0=0; counter_DG0<19; counter_DG0++)
        {
            ...
            for (int counter_N=0; counter_N<20000; counter_N=counter_N+2)
            {
                N=50;
                //N=2+counter_N;
                NA=N/2.0;
                NB=N/2.0;
                rhog =rhog+counter_N*0.00000001;
                cout << NA << " " << NB << endl;
                //exit(0);
...
/********************************* Fixpoint iteration *************************************************************/
        ...
        for (i=0; i<Np; i++)
        {
            ...
            //cout << N << " " << Free_energy_diff << " " << target << endl; 
                 //exit(0);
            //if (Free_energy_diff < target) {myfile2 << N << " " << DG0_star << endl; break;}

            if (exp(Free_energy_diff-1)/CUB(delta/2.0) < rhog ) {myfile2 << rhog << " " << DG0_star << " " << exp(Free_energy_diff-1)/CUB(delta/2.0) << endl; break;}
