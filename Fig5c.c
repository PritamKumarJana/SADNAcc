/* This program is used to obtain Figure 3*/
    ...
    for (int counter_r=0; counter_r<rmax; counter_r++)
    {
        ...
        for (int counter_DG0=0; counter_DG0 < DG0max; counter_DG0++)
        {
            ...
            for (int counter_N=0; counter_N<Nmax; counter_N=counter_N+1)
            {
                ...
                for (hmax=hmax_; hmax<=hmax_; hmax++)  // to obtain figure 3 (bottom pannel); Use hmax=hmax_ instead of hmax=0 to obtain figure 3 (top pannel);
                {
                    for (h=0; h<hmax; h++)
                    {
                    ...
                    else 
                    {
                        ...
                        cout << "hmax= "<< hmax << " " << " DeltaF_multi(hmax) = " << Free_energy_diff-(-93.2903)-(-21.3174) << endl;
                    }
